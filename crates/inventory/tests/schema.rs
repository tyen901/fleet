...
fn obsolete_schema_is_destroyed_and_recreated_without_migration() {
    ...
    MaterializationInventory::open(&db_path).expect("replace obsolete inventory");
...
fn unversioned_schema_is_destroyed_and_recreated() {
    ...
    MaterializationInventory::open(&db_path).expect("replace unversioned inventory");
...
fn corrupt_database_is_destroyed_and_recreated() {
    ...
    MaterializationInventory::open(&db_path).expect("replace corrupt inventory");
